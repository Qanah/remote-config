            ...
            <div class="px-4 py-6 sm:p-8">
                <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name') }}" required class="mt-1 block w-full rounded-md border-2 border-gray-400 shadow-sm focus:border-primary-500 focus:ring-primary-500 text-base px-3 py-2" placeholder="e.g., control, variant-a">
                    ...
                    <div class="sm:col-span-6">
                        <div class="flex items-center">
                            <input id="is_default" name="is_default" type="checkbox" {{ old('is_default', false) ? 'checked' : '' }} class="h-4 w-4 rounded border-2 border-gray-400 text-primary-600 focus:ring-primary-600">
